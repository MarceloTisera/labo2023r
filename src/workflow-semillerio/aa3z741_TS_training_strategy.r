...
PARAM <- list()
PARAM$experimento <- "AFO37410"

PARAM$exp_input <- "AF037310"
...
PARAM$train$testing <- c(202107, 202104, 202106, 202105, 202103, 202102)
...
PARAM$train$semilla <- 509067 # cambiar por su propia semilla  !!!
